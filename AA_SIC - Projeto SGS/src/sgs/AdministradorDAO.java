...
public class AdministradorDAO {
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, String Email) throws PersistentException {
		try {
			return (Administrador) session.load(sgs.Administrador.class, Email);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, String Email) throws PersistentException {
		try {
			return (Administrador) session.get(sgs.Administrador.class, Email);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, String Email, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(sgs.Administrador.class, Email, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, String Email, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(sgs.Administrador.class, Email, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAdministrador(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From sgs.Administrador as Administrador");
		if (condition != null)
	...
	public static Administrador createAdministrador() {
		return new sgs.Administrador();
	}
	
	public static boolean save(sgs.Administrador administrador) throws PersistentException {
		try {
			sgs.SistemadeGestãodeSalasPersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(sgs.Administrador administrador) throws PersistentException {
		try {
			sgs.SistemadeGestãodeSalasPersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(sgs.Administrador administrador) throws PersistentException {
		try {
			sgs.SistemadeGestãodeSalasPersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(sgs.Administrador administrador) throws PersistentException {
		try {
			sgs.SistemadeGestãodeSalasPersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
