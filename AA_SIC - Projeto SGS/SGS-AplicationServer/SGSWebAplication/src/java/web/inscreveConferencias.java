 ...
 * @author franc
 */
@WebServlet(name = "inscreveConferencias", urlPatterns = {"/inscreveConferencias"})
public class inscreveConferencias extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Utilizador")){
            ...
            request.getRequestDispatcher("/WEB-INF/inscreveConferencias.jsp").forward(request, response);
        }
    }
