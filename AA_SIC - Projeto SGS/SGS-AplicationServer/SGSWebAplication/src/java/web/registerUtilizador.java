 ...
 * @author franc
 */
@WebServlet(name = "registerUtilizador", urlPatterns = {"/registerUtilizador"})
public class registerUtilizador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/registerUtilizador.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String isValid = utilizadorBean.createUtilizador(json.get(0), json.get(1), (json.get(2)),
                Integer.parseInt(json.get(3)), json.get(4), json.get(5).charAt(0));
        writer.println(isValid);
        if(isValid.equals("true")){
            session.setAttribute("Type", "Utilizador");
