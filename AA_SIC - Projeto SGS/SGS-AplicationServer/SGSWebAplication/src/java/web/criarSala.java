 ...
 * @author franc
 */
@WebServlet(name = "criarSala", urlPatterns = {"/criarSala"})
public class criarSala extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Administrador")){
            ...
            request.getRequestDispatcher("/WEB-INF/criarSala.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Administrador")){
            ...
            boolean valid = salaBeans.createSala(json.get(0), json.get(1), Integer.parseInt(json.get(2)));
