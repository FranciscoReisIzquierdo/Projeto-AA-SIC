    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Administrador")){
            ...
            if(json.get(0).equals("Edit")){
                String message = conferenciaBean.updateConferencia(json.get(1), json.get(2), Long.parseLong(json.get(3)), Long.parseLong(json.get(4)),
                        Boolean.parseBoolean(json.get(6)), json.get(7), json.get(8), json.get(9), json.get(5));
                writer.println(message);
            }
            else if(json.get(0).equals("Delete")) conferenciaBean.deleteConferencia(json.get(1));
        }
    }
