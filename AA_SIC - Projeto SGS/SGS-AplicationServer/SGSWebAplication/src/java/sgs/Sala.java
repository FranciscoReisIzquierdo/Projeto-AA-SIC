...
public class Sala {
	...
	public int getLotacao() {
                SalaFunctions salaFunctions = new SalaFunctions();
                Evento evento = salaFunctions.getEvento(this);
                if(evento == null) return 0;
                if(evento instanceof Aula) return ((Aula) evento).presentes.size();
                else return ((Conferencia) evento).presentes.size();
	}
