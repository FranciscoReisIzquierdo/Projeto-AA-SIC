...
<html>
    ...
    <body>
        ...
        <a href="alunoMainMenu">Menu Principal</a> > Editar Perfil
        ...
        <div class="form-container">
            ...
            <form id="registerUtilizadorForm">
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="<%= aluno.getEmail() %>" class="form-input" readonly>
                </div>
                <div class="form-group">
                    <label for="genero">Senha</label>
                    <input type="password" name="senha" value="<%= aluno.getSenha() %>" class="form-input" required>
                </div>
                <div class="form-group">
                    <label for="nome">Nome</label>
                    <input type="text" name="nome" value="<%= aluno.getNome() %>" class="form-input" required>
                </div>

                <div class="form-group">
                    <label for="cartao">Numero/Identificador Mecanográfico</label>
                    <input type="text" name="cartao" value="<%= aluno.getNumero() %>" class="form-input" required>
                </div>

                <div class="form-group">
                    <label for="idade">Idade</label>
                    <input type="number" name="idade" value="<%= aluno.getIdade() %>" class="form-input" required>
                </div>

                <div class="form-group">
                    <label for="genero">Genero</label>
                    <select id="genero" name="genero" class="form-select">
                            <option value="M" <%if(aluno.getGenero() == "M".charAt(0)) out.print("selected"); %>>M</option>
                            <option value="F" <%if(aluno.getGenero() == "F".charAt(0)) out.print("selected"); %>>F</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="ano">Ano</label>
                    <input type="number" name="ano" value="<%= aluno.getAno() %>" class="form-input" required>
                </div>
