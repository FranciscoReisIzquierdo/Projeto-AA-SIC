...
<html>
    ...
    <body>
        ...
        <a href="adminMainMenu">Main Menu</a> > <a href="conferenciaManager">Gestão de Conferências</a> > Criar Conferência
        ...
        <div class="form-container">
            <form id="createConferenciaForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="descricao" class="form-input" placeholder="Descrição">
                </div>

                <div class="form-group">
                    <label for="orador">Orador:</label>
                    <input type="text" name="orador" class="form-input" placeholder="Orador">
                </div>

                <div class="form-group">
                    <label for="tema">Tema:</label>
                    <input type="text" name="tema" class="form-input" placeholder="Tema">
                </div>
