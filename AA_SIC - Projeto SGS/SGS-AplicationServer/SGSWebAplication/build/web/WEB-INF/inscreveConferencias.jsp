<%-- 
    Document   : inscreveConferencias
    Created on : 17/06/2023, 23:21:29
    Author     : franc
--%>
...
<html>
    ...
    <body>
        ...
        <div class="main-menu">
            <a href="utilizadorMainMenu" style="margin-left:15px">Menu Principal</a> > Inscrição em Conferências
        </div>
                ...
                if (rows != null) {
                    for (sgs.Conferencia row : rows) { %>
                        <tr>
                            ...
                            <td onmouseover="expandcolumn('columntema', '250px');" onmouseout="shrinkcolumn('columntema');">
        ...
        <div class="fixed-buttons">
            <button onclick="window.location.href='utilizadorMainMenu'">Voltar</button>
        </div>
    </body>
</html>
