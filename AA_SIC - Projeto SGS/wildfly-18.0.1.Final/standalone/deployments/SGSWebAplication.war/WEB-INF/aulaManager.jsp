<%-- 
    Document   : aulaManager
    Created on : 17/06/2023, 12:54:45
    Author     : franc
--%>
...
<html>
    ...
    <body>
        ...
        <% if (session.getAttribute("createdAula") != null) {
            out.println("<script>confirmMessage('" + session.getAttribute("createdAula") + "');</script>");
            session.setAttribute("createdAula", null);
            }
        %>
                    ...
                    for (sgs.Aula row : rows) { %>
                        <tr>
                            ...
                            <td class="buttons">
                                ...
                                <button id="inscreverButton-<%= row.getCodigo() %>" type="button" onclick="window.location.href='inscreveAulas/?codAula=<%=row.getCodigo()%>'">Inscrever</button>
                                <%
                                    } else{
                                %>
