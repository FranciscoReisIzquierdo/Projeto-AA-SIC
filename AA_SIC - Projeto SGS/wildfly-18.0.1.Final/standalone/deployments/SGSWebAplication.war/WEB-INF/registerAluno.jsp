...
<html>
    ...
    <body>
        ...
        <a href="login">Login</a> > Registar Aluno
        ...
        <div class="form-container">
            <form id="registerUtilizadorForm">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="ano" class="form-input" required>
                </div>
                ...
                if(!dataString.split("//").some(element => element === "NaN" || element === "")){
                    fetch(url, {
                      ...
                      .catch(error => {
                        ...
                        var errorMessage = document.getElementById("errorMessage");
                        errorMessage.textContent = "Erro no registo. Um ou mais campo em falta";
                    }
                }
        </script>
    </body>
