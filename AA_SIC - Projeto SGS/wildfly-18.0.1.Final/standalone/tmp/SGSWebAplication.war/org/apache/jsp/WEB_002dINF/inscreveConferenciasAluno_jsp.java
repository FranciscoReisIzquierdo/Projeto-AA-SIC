 ...
 * Generated at: 2023-06-22 20:09:47 UTC
...
public final class inscreveConferenciasAluno_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("            <a href=\"alunoMainMenu\" style=\"margin-left:15px\">Menu Principal</a> > Inscrição em Conferências\n");
      out.write("        </div>\n");
 ...
 if(row.getLivre()) { 
      ...
      out.print( row.inscritos.contains((sgs.Utilizador) session.getAttribute("Aluno")) ? "checked" : "unchecked" );
