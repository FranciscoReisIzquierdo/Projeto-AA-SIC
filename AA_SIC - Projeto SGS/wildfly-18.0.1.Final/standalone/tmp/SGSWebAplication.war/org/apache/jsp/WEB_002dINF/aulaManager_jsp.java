 ...
 * Generated at: 2023-06-22 20:54:35 UTC
...
public final class aulaManager_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("        <title>Gestão de Aulas</title>\n");
      out.write("        <style>\n");
      out.write("            body {\n");
      ...
      out.write("            var confirmation = confirm(\"Tem a certeza de que pretende eliminar a aula \" + codigo + \"?\");\n");
      ...
      out.write("                    document.getElementById(\"confirmMessage\").textContent = \"Aula \" + codigo + \" eliminada com sucesso!\";\n");
      ...
      out.write("            var disciplinaElement = document.getElementById(\"disciplina-\" + codigo);\n");
      out.write("            var turnoElement = document.getElementById(\"turno-\" + codigo);\n");
      ...
      out.write("                    || disciplinaElement.disabled || turnoElement.readOnly) {\n");
      ...
      out.write("                disciplinaElement.disabled = false;\n");
      out.write("                turnoElement.readOnly = false;\n");
      ...
      out.write("                disciplinaElement.disabled = true;\n");
      out.write("                turnoElement.readOnly = true;\n");
      out.write("                editButton.innerHTML = \"Edit\";\n");
      out.write("                submitChanges(codigo, nomeElement.value, horainicioElement.value, horafimElement.value, salaElement.value,\n");
      out.write("                    disciplinaElement.value, turnoElement.value);\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("        function submitChanges(codigo, nome, horainicio, horafim, sala, disciplina, turno) {\n");
      ...
      out.write("                    \"//\" + sala + \"//\" + disciplina + \"//\" + turno;\n");
      out.write("            \n");
      out.write("            fetch(url, {\n");
      out.write("              method: 'POST',\n");
      out.write("              headers: {\n");
      ...
      out.write("                    document.getElementById(\"confirmMessage\").textContent = \"Aula \" + codigo + \" editada com sucesso!\";\n");
      ...
      out.write("            document.getElementById(\"confirmMessage\").textContent = \"Aula \" + codigo + \" criada com sucesso!\";\n");
      out.write("            setTimeout(function(){\n");
      out.write("                document.getElementById(\"confirmMessage\").textContent = \"\";\n");
      out.write("            }, 3000);\n");
      out.write("        }\n");
      ...
      out.write("            <h1>Gestão de Aulas</h1>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"main-menu\">\n");
      out.write("            <a href=\"adminMainMenu\" style=\"margin-left:15px\">Menu Principal</a> > Gestão de Aulas\n");
      out.write("        </div>\n");
 ...
 if (session.getAttribute("createdAula") != null) {
      ...
      out.write("                    <th style=\"width: 200px\">Ações</th>\n");
      out.write("                </tr>\n");
      out.write("                ");
 List<sgs.Aula> rows = (List<sgs.Aula>) request.getAttribute("allAulas");
      ...
      out.print( row.getCodigo() );
      out.write("</td>\n");
      out.write("                            <td onmouseover=\"expandcolumn('columnname', '200px');\" onmouseout=\"shrinkcolumn('columnname');\">\n");
...
if(row.sala.getCodigo().equals(option)) out.print("selected"); 
      ...
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      out.write("                                <select class=\"cell-content\" style=\"background: transparent;border: none;font-family: Arial, sans-serif; font-size: 16px\" id=\"disciplina-");
      out.print( row.getCodigo() );
      out.write("\" disabled>\n");
      out.write("                                    ");
      ...
      out.print( option );
      out.write('"');
if(row.getDisciplina().getCodigo().equals(option)) out.print("selected"); 
      out.write('>');
      out.print( option );
      out.write("</option>\n");
      out.write("                                    ");
      ...
      out.write("                                </select>\n");
      out.write("                            </td>\n");
      out.write("                            <td id=\"docente-");
      out.print( row.getCodigo() );
      out.write("\" type=\"text\"> ");
      out.print( row.getDocente() != null ? row.getDocente().getEmail() : "Sem docente atribuido" );
      out.write("</td>\n");
      out.write("                            <td>\n");
      out.write("                                <input class=\"cell-content\" style=\"background: transparent;border: none;font-family: Arial, sans-serif; font-size: 16px\" id=\"turno-");
      out.print( row.getCodigo() );
      out.write("\" type=\"text\" value=\"");
      out.print( row.getTurno() );
      out.write("\" readonly>\n");
      out.write("                            </td>\n");
      ...
      out.write("                                <button id=\"inscreverButton-");
      out.print( row.getCodigo() );
      out.write("\" type=\"button\" onclick=\"window.location.href='inscreveAulas/?codAula=");
      out.print(row.getCodigo());
      out.write("'\">Inscrever</button>\n");
      out.write("                                ");

                                    } else{
                                
      out.write("\n");
      out.write("                                <button id=\"presencasButton-");
      out.print( row.getCodigo() );
      out.write("\" type=\"button\" onclick=\"window.location.href='consultarPresencas/?codAula=");
      out.print(row.getCodigo());
      out.write("'\">Presenças</button>\n");
      out.write("                                ");
 } 
      out.write("\n");
      ...
      out.print( row.getCodigo() );
      out.write("\">\n");
      out.write("                                <button style=\"background-color: red; color: #fff; margin-top: 5px;\" type=\"button\" onclick=\"confirmDelete('");
      out.print( row.getCodigo() );
      ...
      out.write("            <button onclick=\"window.location.href='criarAula'\">Criar Aula</button>\n");
