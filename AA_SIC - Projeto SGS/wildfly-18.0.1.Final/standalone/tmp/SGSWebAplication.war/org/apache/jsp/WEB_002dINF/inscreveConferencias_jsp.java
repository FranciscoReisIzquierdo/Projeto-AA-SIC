 ...
 * Generated at: 2023-06-22 16:55:47 UTC
...
public final class inscreveConferencias_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("        <title>Inscrição em Confêrencias</title>\n");
      out.write("        <style>\n");
      out.write("            body {\n");
      ...
      out.write("        }\n");
      out.write("        \n");
      out.write("        function submitChanges(entrada, email, codigoConf) {\n");
      out.write("              const url = window.location.href; // Get the current URL\n");
      out.write("              var data;\n");
      out.write("              if(entrada.checked) data = \"Inscreve//\" + codigoConf + \"//\" + email;\n");
      out.write("              else{ data = \"Desinscreve//\" + codigoConf + \"//\" + email; }\n");
      out.write("\n");
      out.write("              fetch(url, {\n");
      ...
      out.write("            <h1>Inscrição em Conferências</h1>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"main-menu\">\n");
      out.write("            <a href=\"utilizadorMainMenu\" style=\"margin-left:15px\">Menu Principal</a> > Inscrição em Conferências\n");
      out.write("        </div>\n");
 ...
 if(row.getLivre()) { 
      ...
      out.write("\" type=\"text\" value=\"Livre\" readonly>\n");
      out.write("                            </td>\n");
      out.write("                            ");
 } else{ 
      out.write("\n");
      ...
      out.print( row.inscritos.contains((sgs.Utilizador) session.getAttribute("Utilizador")) ? "checked" : "unchecked" );
      ...
      out.print( row.getCodigo() );
      out.write("\" type=\"text\" value=\"");
      out.print( row.getSala().getCodigo() != null ? row.getSala().getCodigo() : "Sem sala atribuida" );
      out.write("\" readonly>\n");
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      ...
      out.write("\" readonly>\n");
      out.write("                            </td>\n");
      out.write("                            <td onmouseover=\"expandcolumn('columntema', '250px');\" onmouseout=\"shrinkcolumn('columntema');\">\n");
      ...
      out.write("            <button onclick=\"window.location.href='utilizadorMainMenu'\">Voltar</button>\n");
      out.write("        </div>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
