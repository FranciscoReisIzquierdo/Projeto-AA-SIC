 ...
 * Generated at: 2023-06-22 16:36:49 UTC
...
public final class cursoManager_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("        <title>Gestão de Cursos</title>\n");
      out.write("        <style>\n");
      out.write("            body {\n");
      ...
      out.write("            var confirmation = confirm(\"Tem a certeza de que pretende eliminar o curso \" + codigo + \"?\");\n");
      ...
      out.write("                        document.getElementById(\"confirmMessage\").textContent = \"Curso \" + codigo + \" eliminado com sucesso!\";\n");
      ...
      out.write("            var duracaoElement = document.getElementById(\"duracao-\" + codigo);\n");
      ...
      out.write("\n");
      out.write("            if (nomeElement.readOnly || duracaoElement.readOnly || descricaoElement.readonly) {\n");
      out.write("                nomeElement.readOnly = false;\n");
      out.write("                duracaoElement.readOnly = false;\n");
      out.write("                descricaoElement.readOnly = false;\n");
      out.write("                editButton.innerHTML = \"Submit\";\n");
      out.write("            } else {\n");
      out.write("                nomeElement.readOnly = true;\n");
      out.write("                duracaoElement.readonly = true;\n");
      out.write("                descricaoElement.readonly = true;\n");
      out.write("                editButton.innerHTML = \"Edit\";\n");
      out.write("                submitChanges(codigo, nomeElement.value, duracaoElement.value, descricaoElement.value);\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        function submitChanges(codigo, nome, duracao, descricao) {\n");
      out.write("            const url = window.location.href; // Get the current URL\n");
      out.write("            const data = \"Edit/\" + codigo + \"/\" + nome + \"/\" + duracao + \"/\" + descricao;\n");
      out.write("\n");
      out.write("            fetch(url, {\n");
      out.write("              method: 'POST',\n");
      out.write("              headers: {\n");
      ...
      out.write("            .then(response => response.text())\n");
      out.write("            .then(html => { console.log(html);\n");
      out.write("                document.getElementById(\"confirmMessage\").textContent = \"Curso \" + codigo + \" editado com sucesso!\";\n");
      out.write("                setTimeout(function(){\n");
      out.write("                location.reload();\n");
      out.write("                document.getElementById(\"confirmMessage\").textContent = \"\";\n");
      out.write("                }, 3000);\n");
      ...
      out.write("            document.getElementById(\"confirmMessage\").textContent = \"Curso \" + codigo + \" criado com sucesso!\";\n");
      out.write("            setTimeout(function(){\n");
      out.write("                document.getElementById(\"confirmMessage\").textContent = \"\";\n");
      out.write("            }, 3000);\n");
      out.write("        }\n");
      ...
      out.write("            <h1>Gestão de Cursos</h1>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"main-menu\">\n");
      out.write("            <a href=\"adminMainMenu\" style=\"margin-left:15px\">Menu Principal</a> > Gestão de Cursos\n");
      out.write("        </div>\n");
 ...
 List<sgs.Curso> rows = (List<sgs.Curso>) request.getAttribute("allCursos");
      ...
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      out.write("                                <input class=\"cell-content\" style=\"background: transparent;border: none;font-family: Arial, sans-serif; font-size: 16px\" id=\"duracao-");
      out.print( row.getCodigo() );
      out.write("\" type=\"number\" value=\"");
      out.print( row.getDuracao() );
      out.write("\" readonly>\n");
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      ...
      out.write("            <button onclick=\"window.location.href='criarCurso'\">Criar Curso</button>\n");
