 ...
 * Generated at: 2023-06-22 19:36:42 UTC
...
public final class disciplinaManager_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("        <title>Gestão de Disciplinas</title>\n");
      out.write("        <style>\n");
      out.write("            body {\n");
      ...
      out.write("            var confirmation = confirm(\"Tem a certeza de que pretende eliminar a disciplina \" + codigo + \"?\");\n");
      ...
      out.write("                        document.getElementById(\"confirmMessage\").textContent = \"Disciplina \" + codigo + \" eliminada com sucesso!\";\n");
      ...
      out.write("            var cursoElement = document.getElementById(\"curso-\" + codigo);\n");
      out.write("            var docenteElement = document.getElementById(\"docente-\" + codigo);\n");
      out.write("            var cargaElement = document.getElementById(\"carga-\" + codigo);\n");
      ...
      out.write("\n");
      out.write("            if (nomeElement.readOnly || cursoElement.disabled || docenteElement.disabled || cargaElement.readOnly \n");
      out.write("                    || descricaoElement.readOnly) {\n");
      out.write("                nomeElement.readOnly = false;\n");
      out.write("                cursoElement.disabled = false;\n");
      out.write("                docenteElement.disabled = false;\n");
      out.write("                cargaElement.readOnly = false;\n");
      out.write("                descricaoElement.readOnly = false;\n");
      out.write("                editButton.innerHTML = \"Submit\";\n");
      out.write("            } else {\n");
      out.write("                nomeElement.readOnly = true;\n");
      out.write("                cursoElement.disabled = true;\n");
      out.write("                docenteElement.disabled = true;\n");
      out.write("                cargaElement.readOnly = true;\n");
      out.write("                descricaoElement.readOnly = true;\n");
      out.write("                editButton.innerHTML = \"Edit\";\n");
      out.write("                submitChanges(codigo, nomeElement.value, cursoElement.value, docenteElement.value, cargaElement.value, descricaoElement.value);\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        function submitChanges(codigo, nome, curso, docente, carga, descricao) {\n");
      out.write("            const url = window.location.href; // Get the current URL\n");
      out.write("            const data = \"Edit//\" + codigo + \"//\" + nome + \"//\" + curso + \"//\" + docente + \"//\" + carga + \"//\" + descricao;\n");
      out.write("            fetch(url, {\n");
      out.write("              method: 'POST',\n");
      out.write("              headers: {\n");
      out.write("                'Content-Type': 'application/json',\n");
      ...
      out.write("                document.getElementById(\"confirmMessage\").textContent = \"Disciplina \" + codigo + \" editada com sucesso!\";\n");
      ...
      out.write("            document.getElementById(\"confirmMessage\").textContent = \"Disciplina \" + codigo + \" criada com sucesso!\";\n");
      out.write("            setTimeout(function(){\n");
      out.write("                document.getElementById(\"confirmMessage\").textContent = \"\";\n");
      out.write("            }, 3000);\n");
      out.write("        }\n");
      ...
      out.write("            <h1>Gestão de Disciplinas</h1>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"main-menu\">\n");
      out.write("            <a href=\"adminMainMenu\" style=\"margin-left:15px\">Menu Principal</a> > Gestão de Disciplinas\n");
      out.write("        </div>\n");
 ...
 if (session.getAttribute("createdDisciplina") != null) {
      ...
      out.write("                    <th id=\"columndocente\">Docente</th>\n");
      out.write("                    <th>Carga</th>\n");
 ...
 List<sgs.Disciplina> rows = (List<sgs.Disciplina>) request.getAttribute("allDisciplinas");
      ...
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      out.write("                                <select class=\"cell-content\" style=\"background: transparent;border: none;font-family: Arial, sans-serif; font-size: 16px\" id=\"curso-");
      out.print( row.getCodigo() );
      out.write("\" disabled>\n");
      out.write("                                    ");
      ...
      out.print( option );
      out.write('"');
if(row.curso.getCodigo().equals(option)) out.print("selected"); 
      out.write('>');
      out.print( option );
      out.write("</option>\n");
      out.write("                                    ");
      ...
      out.write("                                </select>\n");
      out.write("                            </td>\n");
      out.write("                            <td onmouseover=\"expandcolumn('columndocente', '300px');\" onmouseout=\"shrinkcolumn('columndocente');\">\n");
      out.write("                                <select class=\"cell-content\" style=\"background: transparent;border: none;font-family: Arial, sans-serif; font-size: 16px\" id=\"docente-");
      out.print( row.getCodigo() );
      out.write("\" disabled>\n");
      out.write("                                    ");
      ...
      out.print( option );
      out.write('"');
if(row.getDocente().getEmail().equals(option)) out.print("selected"); 
      out.write('>');
      out.print( option );
      out.write("</option>\n");
      out.write("                                    ");
      ...
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      out.write("                                <input class=\"cell-content\" style=\"background: transparent;border: none;font-family: Arial, sans-serif; font-size: 16px\" id=\"carga-");
      out.print( row.getCodigo() );
      out.write("\" type=\"number\" value=\"");
      out.print( row.getCargaHoraria() );
      out.write("\" readonly>\n");
      out.write("                            </td>\n");
      out.write("                            <td>\n");
      ...
      out.write("            <button onclick=\"window.location.href='criarDisciplina'\">Criar Disciplina</button>\n");
