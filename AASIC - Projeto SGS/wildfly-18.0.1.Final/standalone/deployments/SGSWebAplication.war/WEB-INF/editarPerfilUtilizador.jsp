...
<html>
    ...
    <body>
        ...
        <div class="container">
        <h1 class="title">Editar Visitante</h1>
        <a href="utilizadorMainMenu">Visitante Main Menu</a> >
        ...
        <div class="form-container">
            ...
            <form id="registerUtilizadorForm">
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="<%= utilizador.getEmail() %>" class="form-input" placeholder="Email" readonly>
                </div>
                <div class="form-group">
                    <label for="genero">Senha:</label>
                    <input type="password" name="senha" value="<%= utilizador.getSenha() %>" class="form-input" placeholder="Senha" required>
                </div>
                <div class="form-group">
                    <label for="nome">Nome:</label>
                    <input type="text" name="nome" value="<%= utilizador.getNome() %>" class="form-input" placeholder="Nome" required>
                </div>

                <div class="form-group">
                    <label for="cartao">Cartão:</label>
                    <input type="text" name="cartao" value="<%= utilizador.getNumero() %>" class="form-input" placeholder="Cartao" required>
                </div>

                <div class="form-group">
                    <label for="idade">Idade:</label>
                    <input type="number" name="idade" value="<%= utilizador.getIdade() %>" class="form-input" placeholder="Idade" required>
                </div>

                <div class="form-group">
                    <label for="genero">Genero:</label>
                    <input type="text" name="genero" value="<%= utilizador.getGenero() %>" class="form-input" placeholder="Genero" required>
                </div>
