<%-- 
    Document   : inscreveConferenciasDoc
    Created on : 18/06/2023, 12:43:22
    Author     : franc
--%>
...
<html>
    <head>
        ...
        <title>Inscrição de Confêrencias</title>
        <style>
            body {
