...
public class aulaManagerDoc extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Docente")){
            ...
            List<sgs.Aula> allAulas = aulaFunctions.getAllAulasPerDocente(email);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Docente")){
            ...
            if(json.get(0).equals("Edit")){
                String message = aulaFunctions.updateAula(json.get(1), json.get(2), Long.parseLong(json.get(3)), Long.parseLong(json.get(4)),
                        json.get(5), json.get(6), json.get(7));
                writer.println(message);
            }
            else if(json.get(0).equals("Delete")) aulaFunctions.deleteAula(json.get(1));
        }
    }
