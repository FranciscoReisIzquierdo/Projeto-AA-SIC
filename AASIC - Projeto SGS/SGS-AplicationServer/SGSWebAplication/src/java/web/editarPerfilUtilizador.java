...
public class editarPerfilUtilizador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Utilizador")){
            ...
            session.setAttribute("Utilizador", userFunctions.getUtilizador((String) session.getAttribute("Email")));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Utilizador")){
            ...
            if(json.get(0).equals("Edit")){
                String message = userFunctions.updateUtilizador(json.get(1), json.get(2), json.get(3), Integer.parseInt(json.get(4)),
