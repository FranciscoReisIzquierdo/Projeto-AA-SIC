...
public class criarDisciplina extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("Type")!= null && session.getAttribute("Type").equals("Administrador")){
            ...
            sgs.DisciplinaFunctions discFunctions = new sgs.DisciplinaFunctions();
            String isValid = discFunctions.createDisciplina(json.get(0), json.get(1), json.get(2), json.get(3),
