...
public class AulaFunctions {
    public boolean createAula(String nome, long inicio, long fim, String turno, String codigoSala, String discNome) throws PersistentException{
    ...
    public boolean updateAula(String nome, Long horainicio, Long horafim, String turno, String codigoSala, String discNome) throws PersistentException{
        PersistentTransaction t = sgs.SistemadeGestãodeSalasPersistentManager.instance().getSession().beginTransaction();
        try {
