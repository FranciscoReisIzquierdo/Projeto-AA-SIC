...
public class Main {
    ...
    public static void createCurso(){
        System.out.println("Criar curso: nome/descricao/duracao");
        Scanner scanner = new Scanner(System.in);
        String nome = scanner.nextLine();
        ...
        try {
            ...
            boolean result = cursoFunction.createCurso(nome, duracao, descricao);
            if(result) System.out.println("Curso " + nome + " criada com sucesso!\n");
    ...
    public static void createDocente(){
        System.out.println("Criar docente: nome/cartao/email/senha/departamento/idade");
        Scanner scanner = new Scanner(System.in);
        String nome = scanner.nextLine();
        String cartao = scanner.nextLine();
        String email = scanner.nextLine();
        ...
        try {
            ...
            boolean result = docenteFunction.createDocente(nome, idade, cartao, email, senha, departamento);
    ...
    public static void createUtilizador(){
        System.out.println("Criar utilizador: nome/cartao/email/senha/idade");
        Scanner scanner = new Scanner(System.in);
        String nome = scanner.nextLine();
        String cartao = scanner.nextLine();
        String email = scanner.nextLine();
        ...
        try {
            ...
            boolean result = utilizadorFunction.createUtilizador(nome, idade, cartao, email, senha);
    ...
    public static void createDisciplina(){
        System.out.println("Criar disciplina: nome/curso/docente/descricao/carga horaria");
        Scanner scanner = new Scanner(System.in);
        String nome = scanner.nextLine();
        ...
        try {
            ...
            boolean result = disciplinaFunction.createDsciplina(nome, curso, docente, descricao, carga);
    ...
    public static void createConferencia(){
        System.out.println("Criar conferencia nome/descricao/orador/tema/codigoSala/livre/data/inicio/fim");
        Scanner scanner = new Scanner(System.in);
        String nome = scanner.nextLine();
        String descricao = scanner.nextLine();
        ...
        try {
            ...
            boolean result = conferenciaFunction.createConferencia(nome, inicio, fim, data, livre, descricao, orador, tema, codigoSala);
    ...
    public static void deleteConferencia(){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Eliminar conferencia com nome:");
        String nome = scanner.nextLine();
        try {
            sgs.ConferenciaFunctions conferenciaFunction = new sgs.ConferenciaFunctions();
